...
style.theme_create("CustomStyle", parent="alt", settings={
    "TCombobox": {
        "configure": {"selectbackground": "#C1F7F9", "fieldbackground": "#C1F7F9", "foreground": "#000716", "background": "#C1F7F9", "font": ("Inter", 35,"bold")},
        "map": {
            "foreground": [("readonly", "#000716")],
            "fieldbackground": [("readonly", "#C1F7F9")],
            "selectbackground": [("readonly", "#C1F7F9")],
...
combobox.place(x=1051.0, y=517.0, width=121, height=27.0)
